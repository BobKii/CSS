  ...
  res.render("template-5", {
    ...
    advantages: [
      ...
      },
      {
        ...
        text:
          "Fill out all required fields using real data on the checkout page.",
      },
      {
        title: "Loyalty Program",
        text:
          "While you were paying, we had already prepared access to our Member Area, where you can read more about the status of your order.",
      },
    ],
...
//           ↙ тут вводимо шлях (PATH) до сторінки
router.get("/slack-dz", function (req, res) {
  // res.render генерує нам HTML сторінку
